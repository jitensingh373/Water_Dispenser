...
import com.digitalsolution.waterdispenser.activity.MainActivity
...
class MainActivity : MyBaseActivity(), View.OnClickListener, ViewModelStoreOwner {
                        ...
                        val thread = Thread(Runnable {
                            try {
                                if (mTypeWater != null && mQTYWater != null) {
                                    ...
                                    user.dispenserName = "JALDURG_05_01"
                                    user.dispenseTime = "014"
                                    user.timeStamp = 231231
                                    user.waterQuantity = mQTYWater
                                    user.waterType = mTypeWater
